...
public class ScheduleController {
    ...
    public ApiResponse<ListScheduleResponseByPage> getCurrentScheduleInCinemaByPage(@RequestParam Integer cinemaId,
    ...
    public ApiResponse<ListScheduleResponseByPage> getHistoryScheduleInCinemaByPage(@RequestParam Integer cinemaId,
                                                   @RequestParam(defaultValue = "1") Integer page,
                                                   @RequestParam(defaultValue = "5") Integer perPage) {
        return ApiResponse.<ListScheduleResponseByPage>builder()
                .code(200)
    ...
    public ApiResponse<List<ShowFilmByDayResponse>> listScheduleInCinemaByDay(@RequestParam Integer cinemaId,
