...
public class VNPayConstants {
    ...
    public static final String VNP_TMN_CODE = "ZTDPUOSQ";
    public static final String SECRET_KEY = "5WNL3938IZOV7947MYB3E48P2VZO301J";
    ...
    public static final String VNP_IP_ADDR = "192.168.1.55";
