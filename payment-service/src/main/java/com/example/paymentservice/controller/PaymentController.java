...
public class PaymentController {
    ...
    public ApiResponse createPayment(@RequestBody OrderRequest orderRequest,
...
//        String response = service.createOrder(request, orderRequest);
    ...
    public ApiResponse<String> createPayment(@RequestParam(name = "message") String message) throws JsonProcessingException {
